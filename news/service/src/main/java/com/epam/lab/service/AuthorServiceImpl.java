...
public class AuthorServiceImpl implements AuthorService {
    ...
    @Override
    public List<AuthorDTO> selectAuthors(int from, int howMany) {
        return authorRepository.findAll(from, howMany).stream().map(mapperUtil::convertAuthorToDTO).collect(Collectors.toList());
    }
