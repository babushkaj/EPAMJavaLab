...
public class AuthorRepositoryImpl implements AuthorRepository {
    ...
    public long countAll() {
        ...
        Root<Author> authorRoot = criteriaQuery.from(Author.class);
        criteriaQuery.select(criteriaBuilder.count(authorRoot));
